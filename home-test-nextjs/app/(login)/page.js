    ...
    return (
        <div className="min-h-screen flex flex-col justify-center md:flex-row">
            <div className="w-full md:w-1/2 flex  flex-col p-8 md:p-16 bg-[var(--color-background)]">
                ...
                <div className="flex-1  flex flex-col justify-center max-w-md mx-auto w-full">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <p className="italic text-[var(--color-muted)] text-sm text-center">
                           *username : <span className='font-bold text-white '>mor_2314 </span>pass:<span
                            className='font-bold text-white '> 83r5^_</span>
                        </p>
            ...
            <div
                ...
                <div className="absolute top-0 right-0 w-full h-full bg-gradient-to-br from-[#121212] to-[#0f172a] opacity-90"></div>
                <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-[var(--color-primary)] blur-3xl opacity-20"></div>
                <div className="absolute -bottom-40 -left-40 w-80 h-80 rounded-full bg-[var(--color-secondary)] blur-3xl opacity-20"></div>
            </div>
        </div>
